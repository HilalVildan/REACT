...
const OrnekUseEffect = () => {
  ...
  //!!!! setTimeout, zaman aralığından sonra bir işlevi çalıştırmamıza izin verir. 
  //! setInterval, bir işlevi tekrar tekrar çalıştırmamıza, zaman aralığından sonra başlamamıza ve 
  //! ardından o aralıkta sürekli tekrarlamamıza izin verir
  //!component ilk render edildiğinde çalış, useEffect olmazsa, arttır a her basıldığında, 
  //!setTimeout tetiklenir.
  //   useEffect(() => {
  //     setTimeout(() => {
