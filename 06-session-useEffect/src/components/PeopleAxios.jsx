...
const PeopleAxios = () => {
  ...
  useEffect(() => {
    //! axios json formatina kendisi cebviriyor ve post islemi cok kolay
    axios
  ...
  const postInsan = () => {
    axios
      .post("https://jsonplaceholder.typicode.com/users", {
        //   veri
        id: insanlar.length + 1, // su an bu sikinti oluyor fake bi database oldugu icin. gercek databaselerde bu sikinti olmayacak
        name: faker.name.findName(),
        phone: faker.phone.phoneNumber(),
      })
